...
/**
  * Created by sq on 2017/12/28.
  */
object sparkTwoBplu {
  def main(args: Array[String]) {
    val conf = new SparkConf().setAppName("twoBPlus").setMaster("spark://hadoop01:7077")
    ...
    //val lines =sc.textFile("D:/datas/jd_data/count2/[1-8]00/*.txt")
    ...
    println("query time ------> " + nanoEnd + "  " + nanoStart + (end - start) + "    " + (nanoEnd - nanoStart)/1000000)
